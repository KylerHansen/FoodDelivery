...
namespace FoodDelivery.Pages.Customer.Cart
{
    public class SummaryModel : PageModel
    {
        ...
        public IActionResult OnPost(string stripeToken)
        {
            ...
            OrderDetailsCart.OrderHeader.DeliveryTime = Convert.ToDateTime(OrderDetailsCart.OrderHeader.DeliveryDate.ToShortDateString() +
            ...
            if(stripeToken != null)
            {
                ...
                {
                    Amount = Convert.ToInt32(OrderDetailsCart.OrderHeader.OrderTotal * 100), //requires cents
                    Currency = "usd",
